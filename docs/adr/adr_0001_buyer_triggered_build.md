...
**Dispatch target updated (2026-06-03):** per [ADR-0008](adr_0008_self_mint_bubblegum_v2.md), `runImageOps` step (e) now targets the self-mint dispatcher at [deed.md](../registry/deed.md) (Bubblegum V2 `mint_v1` signed by HOT_MINT_KEY) rather than the Crossmint API. The buyer-triggered build trigger is unchanged; only the downstream mint mechanism shifts.
